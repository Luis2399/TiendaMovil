...
$routes->group('api', ['namespace' => 'App\Controllers\API'], function($routes) {
    ...
    $routes->get('carritos', 'Carritos::index');
    $routes->post('carritos/create', 'Carritos::create');
    $routes->get('carritos/edit/(:num)', 'Carritos::edit/$1');
    $routes->put('carritos/update/(:num)', 'Carritos::update/$1');
    $routes->delete('carritos/delete/(:num)', 'Carritos::delete/$1');
    //se crea, se elimina y se actualiza, eso tiene que estar en el carrito/*
